...
- [ ] Note any patterns (same product, same config, repeat issues)
- [ ] Have troubleshooting notes or event log snippets ready to share

## During triage
- [ ] Quick round: case ID, one-line summary, blocker (if any)
- [ ] Identify cases that need escalation to product/engineering
- [ ] Share workarounds or KB links that unblock others
- [ ] Capture “readiness” gaps (missing docs, unclear runbook) for follow-up
