...
- What happened; when detected; current status (contained / in progress / resolved).

## 2. Impact
- **Business:** Systems, data, or customers affected (or not).
...
## 5. Next update
- When you’ll get the next briefing or status (e.g. in 4 hours, at resolution).

## Notes
- Keep slides or bullets to one page if possible.
- Lead with impact and decisions; put technical detail in appendix or backup.
